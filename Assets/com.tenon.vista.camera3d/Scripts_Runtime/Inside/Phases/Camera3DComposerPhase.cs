...
namespace TenonKit.Vista.Camera3D {
    ...
    internal static class Camera3DComposerPhase {
        ...
        static void TickMovingByDriver(Camera3DContext ctx, float dt) {
            ...
            AimDriverWithComposer(ctx, current.ID, mainCamera, driverWorldPos, dt);
        }

        // Aim Driver
        static void AimDriverWithComposer(Camera3DContext ctx, int id, Camera mainCamera, Vector3 driverWorldPos, float deltaTime) {
